...
const FIELD_WHITELIST = new Set(['temperature', 'humidity', 'pressure', 'battery_level', 'signal_strength', 'voltage', 'current_draw', 'power_consumption', 'energy_used', 'data_transmitted', 'light_level', 'wind_speed']);
